...
if(argv.gameport) {
  ...
  gameport = 8869;
  console.log('no gameport specified: using 8869\nUse the --gameport flag to change');
}
...
io.on('connection', function (socket) {
  ...
  var isLab = 0;  // is an RA using the interface to non-anonymously annotate sketches?
  ...
  if (isLab == 1){
    console.log("Is someone in the lab!")
